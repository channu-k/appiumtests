...
public class ChangeVibration extends SupportSetUp {

	@Test
	public void changeVibrationOption() {
		...
		// Change vibrate option
		WebElement alwaysVibrateOption = driver.findElementByName("Always");
		alwaysVibrateOption.click();
